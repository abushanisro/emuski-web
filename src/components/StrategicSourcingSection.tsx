export function StrategicSourcingSection() {
  return (
    <section className="py-20 bg-background">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-4xl mx-auto mt-16 space-y-12">
          ...
          <div>
            <h3 className="text-2xl font-semibold text-foreground text-center mb-4">Digital-First Supplier Intelligence</h3>
            <p className="text-muted-foreground">
              Our in-house digital platform gives OEMs visibility and control across every sourcing decision. With integrated modules for supplier identification, evaluation, and benchmarking, we help OEMs seamlessly explore alternatives, reduce dependency on single regions, and accelerate supplier onboarding in India.
            </p>
          </div>
          <div>
            ...
            <ul className="list-disc list-inside space-y-2 pl-4 text-muted-foreground">
              ...
              <li>Reduce reliance on single-region sourcing by supporting dual/multi-sourcing strategies</li>
              <li>Align sourcing with product design, cost estimation, and manufacturing intelligence</li>
            </ul>
          </div>
          <div>
        ...
        <div className="max-w-4xl mx-auto mt-16">
          <img src="/assets/engineering/sourcing.svg" alt="Strategic Sourcing" className="rounded-lg shadow-lg" />
        </div>
      </div>
    </section>
  );
