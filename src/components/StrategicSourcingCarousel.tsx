...
interface StrategicSourcingCarouselProps {
  className?: string
}

export function StrategicSourcingCarousel({ className = '' }: StrategicSourcingCarouselProps) {
  ...
  const pages = useMemo(
    () =>
      Array.from({ length: 14 }, (_, i) => {
        ...
        return {
          id: i + 1,
          src: `/docs/strategic-sourcing-detailed-analysis-report/strategic-sourcing-analysis-page-${pageNum}.svg`,
          alt: `Strategic Sourcing Analysis Report - Page ${i + 1} of 14`,
        }
      }),
    []
  )
    ...
    <div className={`relative ${className}`}>
      ...
      <div className="flex items-center justify-center gap-2 sm:gap-4 mt-4 sm:mt-6">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {/* Dots - Hidden on mobile, visible on md+ screens */}
