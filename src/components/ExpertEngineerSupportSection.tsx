export function ExpertEngineerSupportSection() {
  return (
    <section className="py-20 bg-background">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-4xl mx-auto mt-16 space-y-12">
          ...
          <div>
            <h3 className="text-2xl font-semibold text-foreground text-center mb-4">Specialized Expertise</h3>
            <p className="text-muted-foreground mb-4">We deploy engineers with hands-on knowledge across critical functions:</p>
            <ul className="list-disc list-inside space-y-2 pl-4 text-muted-foreground">
              <li><strong>Should-Cost Engineers</strong> – building accurate cost models for smarter decision-making</li>
              <li><strong>VAVE Specialists</strong> – identifying cost and design optimization opportunities</li>
              <li><strong>Manufacturing Experts</strong> – ensuring designs align with production realities and assessing and validating suppliers against global standards</li>
            </ul>
          </div>
          <div>
            <h3 className="text-2xl font-semibold text-foreground text-center mb-4">Hands-On Impact</h3>
            <p className="text-muted-foreground mb-4">Our engineers don’t just advise—they execute. They actively:</p>
            <ul className="list-disc list-inside space-y-2 pl-4 text-muted-foreground">
              <li>Build and validate detailed cost models</li>
              <li>Conduct teardown and benchmarking studies</li>
              <li>Support technical supplier evaluations</li>
              <li>Assist in design validation and manufacturability reviews</li>
            </ul>
          </div>
          <div>
