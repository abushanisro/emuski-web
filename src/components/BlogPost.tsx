...
export const BlogPostComponent = () => {
  ...
  useEffect(() => {
    if (post) {
      ...
      updateOrCreateMeta('meta[name="author"]', 'name=author', post.author);
      ...
      updateOrCreateMeta('meta[property="og:site_name"]', 'property=og:site_name', 'EMUSKI');
      updateOrCreateMeta('meta[property="article:published_time"]', 'property=article:published_time', post.publishDate);
      updateOrCreateMeta('meta[property="article:author"]', 'property=article:author', post.author);

      // Twitter Card
      updateOrCreateMeta('meta[name="twitter:card"]', 'name=twitter:card', 'summary_large_image');
      updateOrCreateMeta('meta[name="twitter:title"]', 'name=twitter:title', post.title);
      updateOrCreateMeta('meta[name="twitter:description"]', 'name=twitter:description', post.excerpt);
      updateOrCreateMeta('meta[name="twitter:image"]', 'name=twitter:image', post.image);
      ...
      structuredData.textContent = JSON.stringify({
        ...
        "author": {
          "@type": "Person",
          "name": post.author,
          "url": `https://emuski.com/author/${post.author.toLowerCase().replace(' ', '-')}`
        },
        "publisher": {
          "@type": "Organization",
          "name": "EMUSKI",
