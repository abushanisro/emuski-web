...
interface ProductTeardownCarouselProps {
  className?: string
}

export function ProductTeardownCarousel({ className = '' }: ProductTeardownCarouselProps) {
  ...
  const pages = useMemo(
    () =>
      Array.from({ length: 14 }, (_, i) => {
        ...
        return {
          id: i + 1,
          src: `/docs/product-teardown-analysis-report/product-teardown-analysis-page-${pageNum}.svg`,
          alt: `VAVE Product Teardown Analysis - Page ${i + 1} of 14`,
        }
      }),
    []
  )
